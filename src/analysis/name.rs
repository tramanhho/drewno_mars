...
use crate::parser::ast::span::{line_bytes, node::SpanNode};
...
//         self.report_error(NameError::UndefinedDecl, &id.span.borrow());
//         Err(())
//     }
// }
...
pub enum SymbolKind {
    Variable { var_type: Rc<Type> },
    Function { args: HashMap<String, Rc<Type>>, ret: Rc<Type>}
    // Function
}
...
// trait ArgTable {
//     fn add(&mut self, arg: Rc<FormalDecl>);
//     fn get_types(&self) -> String;
// }

// impl ArgTable for HashMap<String, Rc<Type>>{
//     fn add(&mut self, arg: Rc<FormalDecl>) {
//         let (arg_id, arg_type);
//         use self::FormalDecl::*;
//         match arg {
...
//             self.insert(arg_id, arg_type.clone());
//         }
//     }
